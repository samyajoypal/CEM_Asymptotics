...
\begin{table}[t]
\centering
\caption{Dry Bean applications.  ``SE/local SD'' is the coordinate-median
ratio of an analytic standard error to the standard deviation from successful
local bootstrap fits.  Local success is the percentage of 500 locally
optimized bootstrap refits that passed all convergence diagnostics.}
\label{tab:applications}
\begin{tabular}{lrrrrrr}
\toprule
Varieties & $n$ & ARI & Support & Local success & Naive & Stabilized \\
\midrule
...
\toprule
Quantity & Estimate & Naive SE & Corrected SE & Local SD & Corrected 95\% CI\\
\midrule
