...
\centering
\small
\caption{Selected simulation results. Entries are the coordinate-median ratio
of estimated standard error to empirical standard deviation, followed in
...
\toprule
& \multicolumn{3}{c}{Standard-error ratio} & \multicolumn{3}{c}{Empirical coverage}\\
...
boundary-estimator convergence experiment. The latter shows decreasing root
