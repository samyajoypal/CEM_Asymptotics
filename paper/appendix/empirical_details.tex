...
correction is most important for Normal--Student-$t$ overlap and imbalance, and that
...
\begin{tabular}{rrrrr}
\toprule
Sample size & Bias & Empirical standard deviation & Root mean squared error & Bandwidth\\
\midrule
...
\end{tabular}
\end{center}
Here RMSE denotes root mean squared error. The shrinking bias and variance provide a direct numerical check of the
...
\caption{Coordinate-level root mean squared error atlas for all confirmatory scenarios.}
...
\caption{Coordinate-level estimated-standard-error to empirical-standard-deviation ratio atlas.}
...
\input{appendix/empirical_tables}
